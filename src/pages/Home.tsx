    ...
    <Loading loading={loading} error={error}>
      <div className="m-2">
        <Swiper
          ...
          dir={dir}
          key={dir}
          style={{ marginBottom: "10px", backgroundColor: "#45E7C7" }}
        >
        ...
        <h4 className="ms-4 me-4 d-none d-lg-block">
          {" "}
          {t("Recommended for you")}
        </h4>
        <h4 className="ms-4 me-4 text-center d-lg-none">
          {" "}
          {t("Recommended for you")}
        </h4>
            ...
            >
              ...
              <CardBody>
                ...
                <CardSubtitle className="mb-2 text-muted" tag="h6">
                  ...
                  {items[product.id]
                    ? product.max_quantity - items[product.id].quantity
